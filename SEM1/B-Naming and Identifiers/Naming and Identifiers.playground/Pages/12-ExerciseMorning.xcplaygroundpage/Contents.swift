...
brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
// all the things before school
/*:
 ...
 */
 brushTeeth + chooseClothes + shower + finishHomework + fixLunch
// things I HAVE to do
uploadPhotos + goJogging
// things I would LIKE to do
goJogging
// things I don't HAVE to do and don't LIKE to do
/*:
